#!/usr/bin/python
# << CODE BY RITADI
# << MAU RECODE ??? IZIN DULU LAH,  MINIMAL DM INSTAGRAM @deoktaoz !
...
{Re}║{Gr}  ╚═╝  ╚═╝╚═╝   ╚═╝   ╚═╝  ╚═╝╚═════╝ ╚═╝                  {Re}║
{Re}║                                                              ║
{Re}║{Wh}              ░▒▓█ CYBER INTELLIGENCE █▓▒░                 {Re}║
{Re}║{Wh}              ░▒▓█ OSINT • NETWORK • SECURITY █▓▒░         {Re}║
{Re}║                                                              ║
{Re}║{Ye}                 >>>  CODED BY RITADI  <<<                 {Re}║
{Re}╚══════════════════════════════════════════════════════════════╝

{Gr}               SYSTEM INITIALIZED... READY TO EXECUTE
{Wh}════════════════════════════════════════════════════════════════
